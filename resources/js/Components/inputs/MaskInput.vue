<template>
    <div class="w-full flex flex-col">
        ...
        <InputMask :placeholder="placeholder" v-model="modelValue" fluid :disabled="disabled" :mask="mask" :pt="{
            root: {
                class: [
        ...
        <Message severity="secondary" class="mt-1 mx-1" variant="simple" v-show="message">
